...
export const getIpbeListSelectors = (state, selectors, sliceName?) => {
  ...
  return { 
    ...
    selectIpbeListPagination: () =>
      selectors.selectIpbeListPagination(select),
    selectIpbeListViewMode: () =>
      selectors.selectIpbeListViewMode(select),
    ...
    selectIpbeListSelected: () =>
      selectors.selectIpbeListSelected(select),
};
}