...
const rtpMuxerErrorState: IFormRootState["errors"]["rtpMuxer"] = Object.values(ERTPMuxerError).reduce(
    (obj: any, key) => {
        obj[key] = {
            error: false,
        };
...
export const deleteAudioEncoder = createAction<number, "DELETE_AUDIOENCODER">("DELETE_AUDIOENCODER");

export const changeVideoEncoder = createAction<EVideoEncoder, "CHANGE_VIDEO_ENCODER">("CHANGE_VIDEO_ENCODER");
...
export const changeInterlaced = createAction<keyof typeof EInterlaced, "CHANGE_INTERLANCED">("CHANGE_INTERLANCED");

export const changeKeyint = createAction<number, "CHANGE_KEYINT">("CHANGE_KEYINT");

export const changeScenecutThreshold = createAction<number, "CHANGE_SCENICUT_TRESHOLD">("CHANGE_SCENICUT_TRESHOLD");

export const changeAspectRatio = createAction<EAspectRatio, "CHANGE_ASPECT_RATIO">("CHANGE_ASPECT_RATIO");
...
export const changeProgramNumber = createAction<number, "CHANGE_PROGRAM_NUMBER">("CHANGE_PROGRAM_NUMBER");

export const changeServiceProvider = createAction<string, "CHANGE_SERVICE_PROVIDER">("CHANGE_SERVICE_PROVIDER");
...
export const changeVideoOutputIp = createAction<string, "CHANGE_VIDEO_OUTPUT_IP">("CHANGE_VIDEO_OUTPUT_IP");

export const changeAudioOutputIp = createAction<string, "CHANGE_AUDIO_OUTPUT_IP">("CHANGE_AUDIO_OUTPUT_IP");

export const changeAudioOutputPort = createAction<number, "CHANGE_AUDIO_OUTPUT_PORT">("CHANGE_AUDIO_OUTPUT_PORT");

export const changeVideoOutputPort = createAction<number, "CHANGE_VIDEO_OUTPUT_PORT">("CHANGE_VIDEO_OUTPUT_PORT");

export const changeOutputIp = createAction<IOutputIpPayload, "CHANGE_OUTPUT_IP">("CHANGE_OUTPUT_IP");

export const changeOutputPort = createAction<IOutputPortPayload, "CHANGE_OUTPUT_PORT">("CHANGE_OUTPUT_PORT");

export const changeInputFormat = createAction<EIpbeEncoderVideoFormat, "CHANGE_INPUT_FORMAT">("CHANGE_INPUT_FORMAT");

export const changeApplication = createAction<EApplicationType, "CHANGE_APPLICATION_TYPE">("CHANGE_APPLICATION_TYPE");

export const changeOutputType = createAction<EOutputType, "CHANGE_OUTPUT_TYPE">("CHANGE_OUTPUT_TYPE");
